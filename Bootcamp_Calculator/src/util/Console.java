...
import java.util.Scanner;
	...
	public class Console {
	    ...
	    public static String getLongChoiceString(Scanner sc, String prompt,
	        ...
	        while (!isValid) {
	            ...
	            if (!s.equalsIgnoreCase(s1) && !s.equalsIgnoreCase(s2) && !s.equalsIgnoreCase(s3) && 
	            		!s.equalsIgnoreCase(s4) && !s.equalsIgnoreCase(s5)) {
	                System.out.println("Error! Entry must be '" + s1 + ", " + s2 + ", "
	                		+ s3 + ", " + s4 + "or, " + s5+ "'. Try again.");
	            } else {
	                isValid = true;
	            }
	        }
